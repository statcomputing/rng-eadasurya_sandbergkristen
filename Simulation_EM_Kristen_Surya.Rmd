...
curve(q(x), xlim = c(0,1), add = TRUE, col = "green")
legend("topright", legend = c("Kernel Density", "q(x) - proportional to density"), 
...
curve(q(x), xlim = c(0,1), add = TRUE, col = "green")
legend("topright", legend = c("Kernel Density Procedure-2", "q(x) - proportional to density"), 
       col = c("red","green"), lty = c(1,1))
```
